...
TripsGrid.propTypes = {
  trips: propTypes.arrayOf(
    propTypes.shape({
      ...
      departure_station_name: propTypes.string,
      departure_station_station_id: propTypes.number,
      return_station_name: propTypes.string,
      return_station_station_id: propTypes.number,
